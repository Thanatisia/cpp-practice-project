/*
yt-dlp Mass Downloader 
C++

::Features
- Powered by yt-dlp Video Downloader
- Read in text file containing video URL
    + Read all URL/textfiles into vector/List
- Download all videos
    - Loop through all imported URLs and download videos
        yt-dlp {options} "[URL]"
    - Download all videos specified in command line arfguent
- Write downloaded videos into an SQLite/text log file
*/
#include <iostream>
#include <stdexcept>
#include <stdio.h>
